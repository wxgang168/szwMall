...
?>
            <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo htmlspecialchars($this->_var['qq']); ?>&site=<?php echo htmlspecialchars($this->_var['store']['store_name']); ?>&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:<?php echo htmlspecialchars($this->_var['qq']); ?>:51" alt="有事咨询我" title="有事咨询我" align="absmiddle"/></a>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
