...
?>
                            <li>
                                <div class="pic"><a href="<?php echo url('app=goods&id=' . $this->_var['sgoods']['goods_id']. ''); ?>" target="_blank"><img src="<?php echo $this->_var['sgoods']['default_image']; ?>" width="160" height="160" /></a></div>
                                ...
                                <p><em></em><?php echo price_format($this->_var['sgoods']['price']); ?></p>
                            </li>
            ...
            <?php if ($this->_var['searched_goods']): ?><?php echo $this->fetch('page.bottom.html'); ?><?php endif; ?>
        </div>
    </div>
</div>
