...
<div id="content">
    ...
    <div id="right">
        ...
        <div class="die6">
        <?php echo html_filter($this->_var['store']['description']); ?></div>
...
?>
                        <li>
                            <div class="pic"><a href="<?php echo url('app=groupbuy&id=' . $this->_var['groupbuy']['group_id']. ''); ?>" target="_blank"><img src="<?php echo $this->_var['groupbuy']['default_image']; ?>" /></a></div>
