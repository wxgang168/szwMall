    ...
    <div id="mall-desc2">
        <div id="footer_links2">
            ...
            <dl style="width:100px;"> 
            	<dt>特色服务</dt>
                <dd> 
                     <a href="index.php?app=article&act=view&article_id=22" target="_blank">会员卡购买</a>
                </dd>
            </dl>
            ...
            <dl style="width:200px; border-right:0px;"> 
                ...
                <dd>客服电话：400-800-8000<br>
                     <span class="fl">客服邮箱：wx@vchuang.cn</span><br>
                     <span class="fl">官方淘宝店：bbs.52jscn.com</span>
                </dd>
            </dl>
        </div>
        <div class="clear"></div>
