                            ...
                            <a href="<?php echo url('app=groupbuy&id=' . $this->_var['group']['group_id']. ''); ?>">
                                <div class="con">
                                    <div class="tuan_imgbox">
                                        ...
                                        <p style="margin:0;"><?php echo htmlspecialchars($this->_var['group']['group_name']); ?></p>
                                    </div>
...
?>
                ...
                <div class="lists">
                    <h2>新品上市<a href="index.php?app=store&act=search&id=<?php echo $this->_var['store']['store_id']; ?>&order=add_time">查看更多>></a></h2>
                    <ul>
