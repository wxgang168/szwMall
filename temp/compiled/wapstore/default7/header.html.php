    ...
    <div class="header">
        ...
        <div class="nav">
            <ul>
                ...
                <li class="user"><a href="<?php if ($this->_var['visitor']['user_id']): ?><?php echo url('app=buyer_order'); ?><?php else: ?><?php echo url('app=member&act=login&ret_url=' . $this->_var['ret_url']. ''); ?><?php endif; ?>"></a></li>
        ...
        <div class="sub_menu">
            <ul>
                ...
                <li>
                    <a href="index.php?app=store&act=search&id=<?php echo $this->_var['store']['store_id']; ?>&order=add_time">最新商品</a>
                </li>
                <?php endif; ?>
                ...
                <li>
                    <a href="index.php?app=store&act=search&id=<?php echo $this->_var['store']['store_id']; ?>&order=views">热门商品</a>
                </li>
                <?php endif; ?>
