                    ...
                    <div class="sort">
                        <ul>
                            ...
                            <a href="index.php?app=store&act=search&id=<?php echo $this->_var['store']['store_id']; ?>&order=add_time">
                                <li>
                                    <img src="<?php if ($this->_var['store']['store_new_images']): ?><?php echo $this->_var['store']['store_new_images']; ?> <?php else: ?><?php echo $this->res_base . "/" . 'images/sort_icon1.png'; ?><?php endif; ?> " />
                                    <span>最新商品</span>
                                </li>
                            </a>
                            <?php endif; ?>
                            ...
                            <a href="index.php?app=store&act=search&id=<?php echo $this->_var['store']['store_id']; ?>&recommended=1">
                                <li>
                                    <img src="<?php if ($this->_var['store']['store_recommend_images']): ?><?php echo $this->_var['store']['store_recommend_images']; ?> <?php else: ?><?php echo $this->res_base . "/" . 'images/sort_icon2.png'; ?><?php endif; ?>" />
                                    <span>推荐商品</span>
                                </li>
                            </a>
                            <?php endif; ?>
                            ...
                            <a href="index.php?app=store&act=search&id=<?php echo $this->_var['store']['store_id']; ?>&order=views">
                                <li>
                                    <img src="<?php if ($this->_var['store']['store_hot_images']): ?><?php echo $this->_var['store']['store_hot_images']; ?> <?php else: ?><?php echo $this->res_base . "/" . 'images/sort_icon3.png'; ?><?php endif; ?>" />
                                    <span>热门商品</span>
                                </li>
                            </a>
                            <?php endif; ?>
